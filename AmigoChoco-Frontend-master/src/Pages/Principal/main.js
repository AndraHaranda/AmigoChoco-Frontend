...
export default function Principal() {
  ...
  const deleteUser = nomeGrupo => {

    api.delete('grupo?nomeGrupo=' + nomeGrupo)
      .then(res => {
        ...
        <Grid className={classes.heroContent}>
          ...
          <Grid container
            ...
            {!loading && grupos.map(grupo => (
              ...
              <Card key={grupo._id} className={classes.card}>
                <CardContent className={classes.cardContent}>
                  <img alt="FotodoGrupo" width="367" height="200" src={grupo.imagem} />
                  ...
                  <Typography variant="body2" color="textSecondary" component="p">
                    <Box fontStyle="oblique" m={1}>
                      Data do Sorteio : {grupo.dataSorteio}
                    </Box>
                  </Typography>
                </CardContent>
                <CardActions>
                  ...
                  <Link style={{ color: 'inherit', textDecoration: 'none' }} to='/editarCurso' >
                    <Button className={classes.Btns} variant="outlined" color="primary" onClick={() => EditUser(grupo._id)}>
                      Editar
                      </Button>
                  </Link>
                  <Button className={classes.Btns} variant="outlined" color="primary" onClick={() => deleteUser(grupo.nomeGrupo)}>
                    Deletar
                      </Button>
                </CardActions>
              </Card>
